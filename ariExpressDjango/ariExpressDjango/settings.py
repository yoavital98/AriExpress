"""
Django settings for ariExpressDjango project.
...
SECRET_KEY = 'django-insecure-f%qzy7na7v+u*ppa(gv8wo&(s@*ya4=3h=9chkq-c(iox0uod_'
...
ROOT_URLCONF = 'ariExpressDjango.urls'
